...
let Api = (() => {
    ...
    return class Api extends base_1.default {
        static {
            _user_decorators = [(0, Endpoint_1.default)("users/@me")];
        ...
        url = (__runInitializers(this, _instanceExtraInitializers), "https://discord.com/api");
        user = __runInitializers(this, _user_initializers, user_1.default.use());
    };
})();
